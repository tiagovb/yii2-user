...
return [
    ...
    'You can assign multiple roles or permissions to user by using the form below' => 'Você pode atribuir múltiplos papéis ou permissões para o usuário usando o formulário abaixo',
